...
public class MovieController {
    ...
    public RpcResult<MovieDTO> get(@ModelAttribute @Validated MovieInfoQuery query) {
        return RpcResult.successResult(movieManager.get(query));
    }
